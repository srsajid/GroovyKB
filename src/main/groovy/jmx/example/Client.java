 ...
 * MXBean jmx.example. It also listens for Hello MBean notifications.
 */
...
//        JMXServiceURL url = new JMXServiceURL("service:jmx:rmi:///jndi/rmi://:9999/jmxrmi");
        JMXServiceURL url = new JMXServiceURL("service:jmx:rmi://127.0.0.1:9999/jndi/rmi://127.0.0.1:1234/jmxrmi");
	...
	mbsc.addNotificationListener(mbeanName, listener, null, null);
        ...
        ObjectName mxbeanName =
            new ObjectName("com.jmx.example:type=QueueSampler");
